...
class MaxPooling(BaseTrainer):
    ...
    def _train_iter(self, epoch):
        ...
        for i, (feature, target, slide_id) in enumerate(self.train_loader):
            ...
            weight1, pre_features, pre_weight1 = reweighting.weight_learner(input.detach().clone(), pre_features, pre_weight1, stable_cfg, epoch, i)
